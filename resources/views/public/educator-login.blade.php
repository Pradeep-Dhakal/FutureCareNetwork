...
<title>Educator Login — Future Care Network</title>
  ...
  <div class="row justify-content-center">
    <div class="col-md-6 col-lg-5">
      <div class="card mx-auto">
        <div class="icon">👩‍🏫</div>
        <h4 class="fw-bold mb-1" style="color:#1B2A4A;">Educator Login</h4>
        <p class="text-muted small mb-4">Access your Future Care Network educator account</p>

        @if($errors->any())
          <div class="alert alert-danger small rounded-3">{{ $errors->first() }}</div>
        @endif

        <form method="POST" action="{{ route('educator.login.post') }}">
          @csrf
          <div class="mb-3">
            <label class="form-label" style="font-size:.875rem;font-weight:500;">Email Address</label>
        ...
        <div class="text-center">
          ...
          <a href="{{ route('educator.register') }}" class="btn btn-outline-secondary btn-sm px-4">Register as an Educator</a>
        </div>
